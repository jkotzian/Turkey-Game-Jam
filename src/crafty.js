...
Crafty.c("Gravity", {
    ...
    gravity: function (comp) {
        ...
        if(isNaN(this._jumpSpeed)) 
        this._jumpSpeed = 0; //set to 0 if Twoway component is not present
        this._jumpSpeed = this._myJumpSpeed;
...
Crafty.c("Twoway", {
    ...
    twoway: function (speed, jump) {
        ...
        if (arguments.length < 2){
          ...
          this._myJumpSpeed = this._speed * 2;
        } else{
          this._jumpSpeed = jump;
          this._myJumpSpeed = jump;
        }
